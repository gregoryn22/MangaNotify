...
class TestWatchlistEndpoints:
    ...
    def test_set_progress(self, client, sample_watchlist):
        ...
        response = client.patch("/api/watchlist/1677/progress", json={"mark_latest": True})
        assert response.status_code == 200
    ...
    def test_set_status(self, client, sample_watchlist):
        ...
        response = client.patch("/api/watchlist/1677/status", json={"status": "finished"})
        assert response.status_code == 200
...
class TestNotificationEndpoints:
    ...
    def test_get_notifications(self, client, sample_notifications):
        ...
        chapter_notification = next(n for n in data["data"] if n["kind"] == "chapter_update")
